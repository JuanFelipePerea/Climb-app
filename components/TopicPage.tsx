...
.tp-main  { max-width: 100%; padding: 24px 16px 80px; font-family: Inter, system-ui, sans-serif; }
.tp-h1    { font-family: 'Plus Jakarta Sans', system-ui, sans-serif; font-weight: 800; color: var(--dark); margin: 0 0 14px 0; line-height: 1.15; font-size: 26px; }
.tp-bc-link {
  display: inline-flex; align-items: center; gap: 6px;
  font-size: 14px; color: var(--primary); font-weight: 500;
  min-height: 44px; transition: opacity 150ms;
}
@media (min-width: 1024px) {
  .tp-main { max-width: 720px; margin: 0 auto; padding: 40px 24px 80px; }
    ...
    <>
      ...
      <main className="tp-main">
        ...
        <header style={{ marginBottom: '32px' }}>
          ...
          <h1 className="tp-h1">{topic.title}</h1>
